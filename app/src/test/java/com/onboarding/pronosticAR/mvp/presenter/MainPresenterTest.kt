...
class MainPresenterTest {
    ...
    private val emptyApiEntity = getEmptyApiEntity()
    ...
    companion object {
        ...
        private fun getEmptyApiEntity(): ForecastApiEntity = ForecastApiEntity("", 0, 0, listOf(),
            City(0, "", Coordinates(0.0, 0.0), "", 0, 0, 0, 0))
    }
}
